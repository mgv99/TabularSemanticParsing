This folder only contains the tables.json file from the Spider dataset. To download the full dataset, go to the official release. It can be found in the [original TabularSemanticParsing repository](https://github.com/salesforce/TabularSemanticParsing#spider)
